...
function Background() {
  return (
    //* Este div define el color de fondo
    <div className="absolute inset-0 z-0 flex flex-row justify-center overflow-hidden bg-black">
      {/* soft glow */}
      <div
        style={{
          background:
      ...
      {Array.from({ length: LANES }, (_, i) => (
        //* Este div define el color de las lineas
        <div key={i} className="flex h-full w-10 shrink-0 justify-center">
          <div className="relative h-full w-px rotate-12 bg-[var(--turquesa)]/20">
